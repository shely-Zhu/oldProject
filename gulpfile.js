...
function getLocalIp() {
    ...
    for (var devName in osNet) {
        ...
        for (var i = 0; i < iface.length; i++) {
            var alias = iface[i];
            if (alias.family === 'IPv4' && (devName == '本地连接' || devName == '以太网' || devName == "WLAN" || devName == '无线网络连接' || devName == '本地连接 2' || devName == 'en0' || devName == 'en7')) {
        ...
        middleware: function(connect, opt) {
            return [
                proxy('/app', {
                    ...
                    // target:"https://app.haomaojf.com", //预生产
                    // target: "https://app.chtfund.com", //生产
                    changeOrigin: true,
                    secure: false,
                }),
                ...
                proxy(['/wap', '/web/', '/jf/'], {
                    ...
                    // target:"https://h5.haomaojf.com", //预生产
                    // target: "https://h5.chtfund.com", //生产
                    changeOrigin: true,
                    secure: false,
                }),
