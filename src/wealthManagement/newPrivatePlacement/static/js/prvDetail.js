        ...
        var obj = [{
            ...
            callbackDone: function(data) {
                var json = data.data,
                    ...
                    investDirection = json.investDirection;
                ...
                if(investDirection == "0" || investDirection == "2" || investDirection == "4") { // 债权投资、股权投资、其他服务不展示
                    that.getElements.$tipIcon.hide();
                } else if(investDirection == "1"){ // 二级市场展示
                ...
                if (that.contact) { // 联系了理财师
                    ...
                    $.elasticLayer({
                        ...
                        callback: function() {
                            ...
                            if (that.custType == "1") {
                                window.location.href = site_url.riskResult_url + '?src=per';
                            } else {
                                window.location.href = site_url.riskResult_url + '?src=org';
                            }
                        }
                    })
                    $this.removeClass("stop");
                    ...
                    if (that.investorClassify == "1") { // 专业投资者
                        ...
                        $.elasticLayer({
                            id: "msgTip",
                            title: '提示', //如果不传默认为'尊敬的用户'
                            p: '<p>您选择的产品与您现在的风险承受能力相匹配。</p>'+'<p>当前的投资者类型为普通投资者，普通投资者在信息告知、风险警示、适当性匹配等方面享有特殊保护，请您认真阅读<a class="tipTxt" href="javaScript:;" target="_blank">' + resName + '</a>，确认后继续预约产品。</p>',
                            yesTxt: '去阅读',
                            celTxt: '取消',
                            zIndex: 60,
                            yesButtonPosition: 'right',
