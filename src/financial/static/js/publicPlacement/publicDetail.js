        ...
        getData2: function(type, time, end) {
            ...
            var obj = [{
                ...
                callbackDone: function(json) {
                    ...
                    switch (Number(time)) {
                        case 0:
                            that.gV['echartsData'].sinceNow = newData;
                            break; // 成立至今
                        case 1:
                            that.gV['echartsData'].oneMonth = newData;
                            break; // 月
                        case 3:
                            that.gV['echartsData'].threeMonth = newData;
                            break; // 季
                        case 6:
                            that.gV['echartsData'].sixMonth = newData;
                            break; // 半年
                        case 12:
                            that.gV['echartsData'].oneYear = newData;
                            break; // 近一年
                    }
        ...
        events: function() {
            ...
            mui("body").on('mdClick', ".fundManagerCon", function(e) {
                if (that.gV.json.fundManager != "") {
                    window.location.href = site_url.pofFundManager_url + '?fundCode=' + fundCode + '&appNewWebView=1';
                }
            }, {
            ...
            mui("body").on('mdClick', ".fundCompanyCon", function(e) {
                if (that.gV.json.fmcComName != "") {
                    window.location.href = site_url.pofFundCompany_url + '?fundComId=' + that.fundComId + '&appNewWebView=1';
                }
            }, {
