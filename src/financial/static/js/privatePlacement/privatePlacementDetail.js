                ...
                callbackDone: function(json) { //成功后执行的函数
                    ...
                    $.each(jsonData, function(e, v) {
                        ...
                        if (v.show == "1") { //如果显示。show=1
                            ...
                            that.$e.realLi.eq(Number(e) + 1).find(".tips-li-right").attr("conditionType",v.conditionType)
                            that.$e.realLi.eq(Number(e) + 1).find(".tips-li-right").attr("conditionJump",v.conditionJump)
                        }
                        //						对应的条件认证到哪里
