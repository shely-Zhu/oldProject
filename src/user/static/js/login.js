        ...
        events: function() {
            ...
            that.getElements.btn.on('click', function(e) {
                ...
                */
                ...
                //发送ajax请求
                var obj = [{
                    url: site_url.login_api,
                    data: {
                        hmac: "", //预留的加密信息     
                        params: {
                            custType: nameValue, //客户类型（0机构，1个人）
                            loginPhone: phoneValue, //账号
                    ...
                    callbackDone: function(json) {
                        ...
                        if (splitUrl['redirectUrl']) {
                            //跳转到来之前的url
                            window.location.href = new Base64().decode(splitUrl['redirectUrl']);
                        } else if (splitUrl['originUrl']) {
                            //跳转到来之前的url
                            window.location.href = new Base64().decode(splitUrl['originUrl']);
                        } else {
                            window.location.href = "/personal/views/accountMerge.html"
                        }
                    },
