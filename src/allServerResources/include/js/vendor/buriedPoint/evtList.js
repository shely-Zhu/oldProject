...
var evtList = {
	...
	'login': {type:'click', evtid:3,  topic:'登录按钮点击', info: '登录页面-登录按钮点击' },
	
	'index_btn_myaccount': {type:'click', evtid:4,  topic:'我的账户按钮点击', info: '首页-我的账户按钮点击' },
	'index_btn_banner': {type:'click', evtid:5,  topic:'banner点击', info: '首页-banner点击' },
	'index_btn_about': {type:'click', evtid:6,  topic:'关于恒天按钮点击', info: '首页-关于恒天-左侧悬浮框按钮点击' },
	'index_btn_news': {type:'click', evtid:7,  topic:'恒天新闻按钮点击', info: '首页-恒天新闻-左侧悬浮框按钮点击' },
	'index_btn_vip': {type:'click', evtid:8,  topic:'会员尊享按钮点击', info: '首页-会员尊享-左侧悬浮框按钮点击' },
