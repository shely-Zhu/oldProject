...
/**************************************************************mine文件夹结束*****************************************************************************************/ 
	...
	"privateDetailList_6":{ type:'click', evtid: 'privateDetailList_6', topic: '私募交易详情_去合格投资者认证', info: ''},
	"privateDetailList_7":{ type:'click', evtid: 'privateDetailList_7', topic: '私募交易详情_去签合同', info: ''},
	"privateDetailList_8":{ type:'click', evtid: 'privateDetailList_8', topic: '私募交易详情_查看合同', info: ''},
	"privateDetailList_9":{ type:'click', evtid: 'privateDetailList_9', topic: '私募交易详情_去上传汇款凭证', info: ''},
	...
	"tobeConfirmTransaction_5":{ type:'click', evtid: 'tobeConfirmTransaction_5', topic: '待确认交易_去合格投资者认证', info: ''},
	"tobeConfirmTransaction_6":{ type:'click', evtid: 'tobeConfirmTransaction_6', topic: '待确认交易_去签合同', info: ''},
	"tobeConfirmTransaction_7":{ type:'click', evtid: 'tobeConfirmTransaction_7', topic: '待确认交易_查看合同', info: ''},
	"tobeConfirmTransaction_8":{ type:'click', evtid: 'tobeConfirmTransaction_8', topic: '待确认交易_去上传汇款凭证', info: ''},
	"tobeConfirmTransaction_9":{ type:'click', evtid: 'tobeConfirmTransaction_9', topic: '待确认交易_详情', info: ''},
	"tobeConfirmTransaction_10":{ type:'click', evtid: 'tobeConfirmTransaction_10', topic: '待确认交易_视频双录', info: ''},
